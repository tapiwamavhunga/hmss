    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('messages.employee_payroll.payroll_id'), 'payroll_id')
                ->searchable()
                ->view('case_handlers.columns.case_handler_payroll.payroll_id')
                ->sortable(),
            ...
            Column::make(__('messages.employee_payroll.basic_salary'), 'basic_salary')
                ->searchable()
                ->view('case_handlers.columns.case_handler_payroll.basic_salary')
                ->sortable(),
            Column::make(__('messages.employee_payroll.allowance'), 'allowance')
                ->view('case_handlers.columns.case_handler_payroll.allowance')
                ->sortable(),
            Column::make(__('messages.employee_payroll.deductions'), 'deductions')
                ->view('case_handlers.columns.case_handler_payroll.deductions')
                ->sortable(),
            Column::make(__('messages.employee_payroll.net_salary'), 'net_salary')
                ->view('case_handlers.columns.case_handler_payroll.net_salary')
                ->sortable(),
            Column::make(__('messages.common.status'), 'status')
                ->view('case_handlers.columns.case_handler_payroll.status')
                ->sortable(),
