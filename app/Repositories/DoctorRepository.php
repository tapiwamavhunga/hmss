...
class DoctorRepository extends BaseRepository
{
    ...
    public function store(array $input, bool $mail = true): bool
    {
        try {
            ...
            $input['appointment_charge'] = removeCommaFromNumbers($input['appointment_charge']) ?? 0;
    ...
    public function update($doctor, $input): bool
    {
        try {
     ...
     * @return mixed
     */
    public function getDoctorAssociatedData(int $doctorId)
    {
