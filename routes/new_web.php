...
Route::middleware('auth', 'verified', 'xss', 'multi_tenant', 'checkUserStatus')->group(function () {
    ...
    Route::middleware('role:Admin|Patient|Doctor|Receptionist|Nurse|Accountant|Lab Technician|Pharmacist|Case Manager')->group(function () {
        Route::prefix('employee')->group(function () {
            Route::get('notice-board', [Employee\NoticeBoardController::class, 'index'])->name('noticeboard')->middleware('modules');
    ...
    Route::middleware('role:Admin|Patient|Doctor|Receptionist')->group(function () {
        ...
        Route::prefix('patient')->group(function () {
            ...
            Route::get('my-prescriptions/{id}', [Patient\PrescriptionController::class, 'show'])->name('prescriptions.show');
        });
    });
    ...
    Route::middleware('role:Admin|Doctor|Receptionist|Accountant')->group(function () {
        Route::get('doctors/{doctor}', [DoctorController::class, 'show'])->where('doctor', '[0-9]+');
    });
    ...
    Route::middleware('role:Admin|Patient')->group(function () {
        Route::prefix('employee')->group(function () {
            ...
            Route::get('invoices/{invoice}/pdf', [Employee\InvoiceController::class, 'convertToPdf'])
                ->where('invoice', '[0-9]+');
            Route::get('bills', [Employee\BillController::class, 'index'])->name('bills.index')->middleware('modules');
    ...
    Route::middleware('role:Admin|Patient')->group(function () {
        Route::prefix('employee')->group(function () {
            ...
            Route::get('patient-diagnosis-test/{patientDiagnosisTest}/pdf',
                [Employee\PatientDiagnosisTestController::class, 'convertToPdf'])->name('patient.diagnosis.test.pdf');
        });
    });
