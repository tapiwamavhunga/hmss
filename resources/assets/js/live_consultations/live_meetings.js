    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.success) {
                ...
                $('#showMeetingDate').
                    text(moment(liveMeeting.consultation_date).
                            format('Do MMM, Y') + ' ' +
                        moment(liveMeeting.consultation_date).format('LT'))
                $('#showMeetingMinutes').
                    text(liveMeeting.consultation_duration_minutes);

                (liveMeeting.host_video == 0) ? $('#showMeetingHost').
                    text('Disable') : $('#showMeetingHost').text('Enable');
                (liveMeeting.participant_video == 0) ? $(
                    '#showMeetingParticipant').text('Disable') : $(
                    '#showMeetingParticipant').text('Enable')
                isEmpty(liveMeeting.description) ? $('#showMeetingDescription').
