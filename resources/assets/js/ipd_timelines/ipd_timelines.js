...
listenClick('.delete-timeline-btn', function () {
    ...
    swal({
        ...
        text: Lang.get('js.are_you_sure_want_to_delete_this')+' '+Lang.get('js.ipd_timeline')+' ?',
        type: 'warning',
        icon: 'warning',
        ...
        if (result) {
            $.ajax({
                ...
                success: function (obj) {
                    ...
                    swal({
                        title: Lang.get('js.deleted')+"!",
                        text: Lang.get('js.ipd_timeline')+' '+Lang.get('js.has_been_deleted'),
                        icon: 'success',
                        confirmButtonColor: '#50cd89',
                        timer: 2000,
                    })
