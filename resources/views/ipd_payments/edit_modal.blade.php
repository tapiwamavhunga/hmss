                ...
                <div class="row">
                    <div class="form-group col-md12 mb-5">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                {{ Form::text('amount', null, ['class' => 'form-control  price-input','id' => 'editIpdPaymentAmount', 'required', 'placeholder' => __('messages.ambulance_call.amount')]) }}
                    ...
                    <div class="form-group col-md-12 mb-5">
                        <div class="form-group">
                            ...
                            <span class="required"></span>
                            {{ Form::text('date', null, ['class' => 'form-control bg-white','id' => 'editIpdPaymentDate','autocomplete' => 'off', 'required', 'placeholder' => __('messages.ipd_patient_charges.date')]) }}
                        </div>
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('charge_type_id', __('messages.ipd_payments.payment_mode').':',['class' => 'form-label']) }}
                        <span class="required"></span>
                        {{ Form::select('payment_mode', getIpdPaymentTypes(), null, ['class' => 'form-select select2Selector', 'id' => 'editIpdPaymentModeId', 'required','placeholder'=> __('messages.ipd_payments.select_payment_mode')]) }}
                    </div>
                    ...
                    <div class="col-md-12 mb-5">
                        <div class="form-group">
                            ...
                            {{ Form::textarea('notes', null, ['class' => 'form-control ', 'rows' => 4,'id'=>'editIpdPaymentNote', 'placeholder' => __('messages.ipd_patient.notes')]) }}
                        </div>
                    </div>
