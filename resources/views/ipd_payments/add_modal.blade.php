                ...
                <div class="row">
                    <div class="form-group col-md-12 mb-5">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                {{ Form::text('amount', null, ['class' => 'form-control  price-input','id' => 'ipdPaymentAmount', 'required', 'placeholder' => __('messages.ambulance_call.amount')]) }}
                    ...
                    <div class="form-group col-md-12 mb-5">
                        <div class="form-group">
                            ...
                            <span class="required"></span>
                            {{ Form::text('date', null, ['class' => 'form-control bg-white','id' => 'ipdPaymentDate','autocomplete' => 'off', 'required', 'placeholder' => __('messages.ipd_patient_charges.date')]) }}
                        </div>
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('charge_type_id', __('messages.ipd_payments.payment_mode').':',['class' => 'form-label']) }}
                        <span class="required"></span>
                        {{ Form::select('payment_mode', getIpdPaymentTypes(), null, ['class' => 'form-select  select2Selector', 'id' => 'ipdPaymentModeId', 'required','placeholder'=> __('messages.ipd_payments.payment_mode')]) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5 ipd_payment_document">
                        ...
                        <div class="d-block">
                            <div class="image-picker">
                                ...
                                <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                      title="{{__('messages.ipd_patient_diagnosis.document')}}">
                                    <label>
                    ...
                    <div class="col-sm-12 ipd_payment_notes">
