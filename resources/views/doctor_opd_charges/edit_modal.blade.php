            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mt-3">
                        ...
                        <span class="required"></span>
                        {{ Form::text('standard_charge', null, ['class' => 'form-control decimal-number', 'id' => 'editDoctorStandardCharge', 'placeholder' => __('messages.doctor_opd_charge.standard_charge')]) }}
                    </div>
                </div>
            </div>
