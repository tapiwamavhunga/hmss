<div class="row">
    ...
    <div class="col-md-4 mb-5">
        <div class="form-group">
            ...
            <span class="required"></span>
            {{ Form::select('currency', adminCurrencies(), null,['class' => 'form-select currency','id'=>'currency','placeholder'=>__('messages.subscription_plans.select_currency'), 'required']) }}
        </div>
    </div>
    <div class="col-md-4 mb-5">
        <div class="form-group">
    ...
    <div class="col-md-4 mb-5">
        <div class="form-group">
            ...
            <span class="required"></span>
            {{ Form::select('frequency', $planType, null, ['required', 'id' => 'planType','class' => 'form-select planType','required']) }}
        </div>
    </div>
    <div class="col-md-4 mb-5 hide_for_trail">
        <div class="form-group">
            {{ Form::label('trial_days', __('messages.subscription_plans.trail_plan').(':'), ['class' => 'form-label']) }}
            {{ Form::text('trial_days', null , ['class' => 'form-control price-input price','placeholder' =>  __('messages.subscription_plans.enter_trial_day'), 'id'=>'trialDays','maxlength' => '3','onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
        </div>
    </div>
    <div class="col-md-4 mb-5 sms-limit-section d-none">
        <div class="form-group">
            {{ Form::label('sms_limit', __('messages.new_change.sms_limit'), ['class' => 'form-label']) }}
            {{ Form::text('sms_limit', null , ['class' => 'form-control','placeholder' =>  __('messages.new_change.enter_sms-limit'), 'id'=>'smsLimit','onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")']) }}
        </div>
    </div>
