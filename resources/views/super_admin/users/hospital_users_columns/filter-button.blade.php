        ...
        <div class="dropdown-menu py-0" aria-labelledby="hospitalUserFilterButton">
            ...
            <div class="p-5">
                ...
                <div class="mb-5">
                    ...
                    {{ Form::select('department_id', $filterHeads[1],null, ['id' => 'roleArr', 'data-control' =>'select2', 'class' => 'form-select status-selector select2-hidden-accessible data-allow-clear="true"']) }}
                </div>
