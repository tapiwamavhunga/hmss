    ...
    <tr>
        <td class="table__item-desc">
            <div class="available-qty-div">
                ...
                <small class="available-quantity{{:uniqueId}}" id="availableQuantity{{:uniqueId}}"></small>
            </div>
        </td>
        <td>
            <input class="form-control prescription-dose" name="dosage[]" type="text" placeholder="<?php echo  __('messages.ipd_patient_prescription.dosage') ?>">
            <small class=" text-danger avalable-amount"></small>
        </td>
        <td>


            <select class="form-select DoseDurationIdTemplate select2Selector" name="day[]" placeholder="select dose Interval" data-id="{{:uniqueId}}">
                {{for doseDuration}}
                    <option value="{{:key}}">{{:value}}</option>
                {{/for}}
            </select>
        ...
        <select class="form-select DoseInterValIdTemplate" name="dose_interval[]" data-id="{{:uniqueId}}">
                {{for doseInterVal}}
                    <option value="{{:key}}">{{:value}}</option>
                {{/for}}
            </select>
