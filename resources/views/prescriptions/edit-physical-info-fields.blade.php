<div class="row gx-10 mb-5">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            {{ Form::label('medical_history', __('messages.new_change.added_at').(':'), ['class' => 'form-label']) }}
            {{ Form::text('medical_history', null, ['class' => (getLoggedInUser()->thememode ? 'bg-light form-control' : 'bg-white form-control'),'id' => 'editPrescriptionAddedAt','autocomplete' => 'off', 'placeholder' => __('messages.new_change.added_at')]) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
    ...
    <div class="col-md-12">
        <div class="form-group mb-5">
            ...
            {{ Form::textarea('problem_description', null, ['class' => 'form-control', 'rows' => 5, 'placeholder' => __('messages.prescription.problem_description')]) }}
        </div>
    </div>
</div>
