            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::select('charge_type', $chargeTypes, null, ['class' => 'form-select','required','id' => 'editChargeTypeId','placeholder' => __('messages.charge_category.select_charge_type')]) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        <span class="required"></span>
                        {{ Form::text('standard_charge', null, ['class' => 'form-control decimal-number','required', 'id' =>'editStdCharge', 'placeholder' => __('messages.charge.standard_charge')]) }}
                    </div>
