...
<div class="row gx-10 mb-5">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::text('dob', null, ['class' => 'form-control bg-white pharmacistBirthDate', 'id' => 'birthDate', 'autocomplete' => 'off', 'tabindex' => '9', 'placeholder' => __('messages.user.dob')]) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
        ...
        <div class="form-group mb-5">
            ...
            <div class="d-flex align-items-center">
                <div class="form-check me-10">
                    <label class="form-label" for="malePharmacist">{{ __('messages.user.male') }}</label>&nbsp;&nbsp;
                    {{ Form::radio('gender', '0', true, ['class' => 'form-check-input', 'id' => 'malePharmacist']) }}
                </div>
                <div class="form-check me-10">
                    <label class="form-label" for="femalePharmacist">{{ __('messages.user.female') }}</label>&nbsp;
                    {{ Form::radio('gender', '1',false, ['class' => 'form-check-input', 'id' => 'femalePharmacist']) }}
                </div>
            </div>
        </div>
    </div>
