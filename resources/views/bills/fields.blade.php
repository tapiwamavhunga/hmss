<div class="row">
    <div class="col-lg-3 col-md-4 col-sm-12 mb-5">
        ...
        {{ Form::select('patient_admission_id', $patientAdmissionIds, null, ['class' => 'form-select', 'id' => 'patientAdmissionId', 'placeholder' => __('messages.document.select_admission_id'),'data-control' => 'select2', 'required']) }}
    </div>
        ...
        <table class="table table-striped" id="billTbl">
            ...
            @if(isset($bill))
                @foreach($bill->billItems as $billItem)
                    <tr>
                        ...
                        <td>
                            {{ Form::text('price[]', number_format($billItem->price), ['class' => 'form-control decimal-number price','required', 'placeholder' => __('messages.bill.price')]) }}
                        </td>
            ...
            @else
                <tr>
                    ...
                    <td>
                        {{ Form::text('price[]', null, ['class' => 'form-control decimal-number price','required', 'placeholder' => __('messages.bill.price')]) }}
                    </td>
