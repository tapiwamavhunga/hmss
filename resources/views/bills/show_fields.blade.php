...
<div class="m-0">
    ...
    <div class="row g-5 mb-11">
        <div class="col-sm-3">
            ...
            <div class="fs-5 text-gray-800">{{ \Carbon\Carbon::parse($bill->patientAdmission->admission_date)->translatedFormat('jS M, Y g:i A') }}</div>
        </div>
        <div class="col-sm-3">
            <div class="pb-2 fs-5 text-gray-600">{{ __('messages.bill.discharge_date').':' }}</div>
            <div class="fs-5 text-gray-800">{{ !empty($bill->patientAdmission->discharge_date)?date('jS M, Y g:i A', strtotime($bill->patientAdmission->discharge_date)):'N/A' }}</div>
        </div>
        <div class="col-sm-3">
    ...
    <div class="flex-grow-1 table-responsive-sm">
