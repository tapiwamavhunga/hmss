<div class="row">
    ...
    <div class="form-group col-sm-6 mb-5">
        ...
        <span class="required"></span>
        {{ Form::select('ambulance_id', $ambulances, null, ['class' => 'form-select','required','id' => 'callAmbulanceId','placeholder'=>__('messages.ambulance_call.select_ambulance'),'data-control' => 'select2']) }}
    </div>
    <div class="form-group col-sm-6 mb-5">
