            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::textarea('header_note', null, ['class' => 'form-control', 'id' => 'editHeaderNote', 'rows' => 1, 'placeholder' => __('messages.ipd_patient_prescription.header_note')]) }}
                    </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::textarea('footer_note', null, ['class' => 'form-control', 'id' => 'editFooterNote', 'rows' => 4, 'placeholder' => __('messages.ipd_patient_prescription.footer_note')]) }}
                    </div>
                </div>
