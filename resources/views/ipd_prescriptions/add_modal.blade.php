                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="available-qty-div1" id="avlQtyDiv">
                                            {{ Form::select('medicine_id[]', [null], null, ['class' => 'form-select medicineId ipd-prescription-medicine select2Selector custom-selector', 'disabled', 'data-medicine-id' => '1','required','placeholder'=>'Select Medicine']) }}
