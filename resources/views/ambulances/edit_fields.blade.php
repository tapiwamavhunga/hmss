<div class="row">
    ...
    <div class="form-group col-sm-6 mb-5">
        {{ Form::label('vehicle_type', __('messages.ambulance.vehicle_type').(':'),['class' => 'form-label required']) }}
        {{ Form::select('vehicle_type', $type,null, ['id'=>'vehicleType','class' => 'form-select','required','data-control' => 'select2']) }}
    </div>
        ...
        <div class="form-group">
            ...
            <div class="form-check form-switch">
                <input class="form-check-input w-35px h-20px is-active" name="is_available" type="checkbox" value="1"
                    {{(isset($ambulance) && ($ambulance->is_available)) ? 'checked' : ''}}>
            </div>
        </div>
    </div>
