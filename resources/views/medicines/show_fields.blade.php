                    ...
                    <div class="card-body  border-top p-9">
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-4 d-flex flex-column">
                                ...
                                <span class="fw-bolder fs-6 text-gray-800">{{ getCurrencyFormat($medicine->selling_price) }}</span>
                            </div>
                            <div class="col-lg-4 d-flex flex-column">
                                <label class="fw-bold text-muted py-3">{{ __('messages.medicine.buying_price')  }}</label>
                                <span class="fw-bolder fs-6 text-gray-800">{{ getCurrencyFormat($medicine->buying_price) }}</span>
                            </div>
                            <div class="col-lg-4 d-flex flex-column">
                            ...
                            <div class="col-lg-4 d-flex flex-column">
                                ...
                                <span class="fw-bolder fs-6 text-gray-800"data-toggle="tooltip" data-placement="right" title="{{ \Carbon\Carbon::parse($medicine->created_at)->translatedFormat('jS M, Y') }}">{{ \Carbon\Carbon::parse($medicine->created_at)->diffForHumans() }}</span>
                            </div>
                            <div class="col-lg-4 d-flex flex-column">
                                <label class="fw-bold text-muted py-3">{{ __('messages.common.last_updated')  }}</label>
                                <span class="fw-bolder fs-6 text-gray-800"data-toggle="tooltip" data-placement="right" title="{{ \Carbon\Carbon::parse($medicine->updated_at)->translatedFormat('jS M, Y') }}">{{ \Carbon\Carbon::parse($medicine->updated_at)->diffForHumans() }}</span>
                            </div>
