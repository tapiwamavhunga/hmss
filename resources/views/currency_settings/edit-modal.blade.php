            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('currency_name', '', ['id'=>'editCurrencyName','class' => 'form-control','required', 'placeholder' => __('messages.currency.currency_name')]) }}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        <span class="required"></span>
                        {{ Form::text('currency_icon', '', ['id'=>'editCurrencyIcon','class' => 'form-control','required', 'placeholder' => __('messages.currency.currency_icon')]) }}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        <span class="required"></span>
                        {{ Form::text('currency_code', '', ['id'=>'editCurrencyCode','class' => 'form-control','required', 'placeholder' => __('messages.currency.currency_code')]) }}
                    </div>
                </div>
