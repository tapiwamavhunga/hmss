    ...
    @foreach($patients as $patient)
        @if(isset($patient->user))
            <tr>
                ...
                <td>{{ !empty($patient->user->full_name) ? $patient->user->full_name : __('messages.common.n/a') }}</td>
                <td>{{ $patient->user->email }}</td>
                <td>{{ !empty($patient->user->phone) ? $patient->user->region_code.$patient->user->phone : __('messages.common.n/a') }}</td>
