...
<div class="row mb-5">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::text('dob', null, ['class' => (getLoggedInUser()->theme_mode) ? 'form-control bg-light patientBirthDate' : 'form-control bg-white patientBirthDate', 'id' => 'birthDate', 'autocomplete' => 'off', 'tabindex' => '4', 'placeholder' => __('messages.user.dob')]) }}
        </div>
    </div>
    <div class="col-md-6">
        ...
        @foreach ($customField as $field)
            ...
            <div class="form-group col-sm-{{ $field['grid'] }} mb-5">
                ...
                @elseif ($field_type == 'multiSelect')
                    {{ Form::select($fieldName . '[]', $field_values, $fieldData, ['class' => $field['is_required'] == 1 ? 'form-select patient-multi-select dynamic-field' : 'form-select patient-multi-select','data-placeholder' => $field['field_name'], 'data-control' => 'select2', 'multiple' => true, $field['is_required'] == 1 ? 'required' : '']) }}
                @else
                ...
                <div class="image-picker">
                    ...
                    <span class="picker-edit rounded-circle text-gray-500 fs-small" data-bs-toggle="tooltip"
                        ...
                        <label>
                            ...
                            {{ Form::file('image', ['class' => 'image-upload d-none', 'accept' => 'image/*']) }}
