<div class="row">
    <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
        ...
        <span class="fs-5 text-gray-800">{{ $patientAdmission->patient->patientUser->full_name }}</span>
    </div>
    <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
    ...
    <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
        ...
        <span
                class="fs-5 text-gray-800">{{ \Carbon\Carbon::parse($patientAdmission->admission_date)->translatedFormat('jS M, Y g:i A') }}</span>
    </div>
    <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
    ...
    <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
        {{ Form::label('agent_name', __('messages.patient_admission.agent_name').':', ['class' => 'pb-2 fs-5 text-gray-600']) }}
        <span
                class="fs-5 text-gray-800">{{ (!empty($patientAdmission->agent_name))?$patientAdmission->agent_name:__('messages.common.n/a') }}</span>
    </div>
    <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
    ...
    <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
        ...
        <span class="fs-5 text-gray-800">{{ ($patientAdmission->status === 1) ? __('messages.common.active') : __('messages.common.de_active') }}</span>
    </div>
    <div class="col-md-6 d-flex flex-column mb-md-10 mb-5">
