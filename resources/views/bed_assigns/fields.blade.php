<div class="row">
    <div class="col-sm-6">
        <div class="mb-5">
            ...
            {{ Form::select('case_id', $cases, null, ['class' => 'form-select', 'required', 'id' => 'caseId', 'placeholder' => __('messages.case.select_case'), 'data-control' => 'select2']) }}
            {{-- {{ Form::select('case_id', $cases, null, ['class' => 'form-select', 'required', 'id' => 'caseId', 'placeholder' => __('messages.case.select_case'), 'data-control' => 'select2', isset($bedAssign->case_id) ? 'disabled' : '']) }} --}}
    ...
    <div class="col-sm-6">
        <div class="mb-5">
            ...
            {{ Form::select('ipd_patient_department_id', [null], null, ['class' => 'form-select', 'required', 'id' => 'ipdPatientId', 'disabled', 'data-control' => 'select2', 'placeholder' => __('messages.new_change.select_ipd_patient')]) }}
        </div>
    </div>
    <div class="col-sm-6">
        <div class="mb-5">
            ...
            {{ Form::select('bed_id', $beds, isset($bedId) ? $bedId : null, ['class' => 'form-select', 'required', 'id' => 'BedAssignBedId', 'data-control' => 'select2', 'placeholder' => __('messages.bed.select_bed')]) }}
        </div>
    </div>
    <div class="col-sm-6">
        <div class="mb-5">
            {{ Form::label('assign_date', __('messages.bed_assign.assign_date').':', ['class' => 'form-label required']) }}
            {{ Form::text('assign_date', null, ['class' => (getLoggedInUser()->thememode ? 'bg-light form-control' : 'bg-white form-control'),'id' => isset($bedAssign) ? 'editBedAssignDate' : 'BedAssignDate', 'required', 'placeholder' => __('messages.bed_assign.assign_date')]) }}
        </div>
    </div>
    @isset($bedAssign)
        <div class="col-sm-6">
