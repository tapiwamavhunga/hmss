<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::select('category_id',$data['radiologyCategories'], null, ['class' => 'form-select radiology-categories-name','required','id' => 'radiologyCategories','placeholder'=>__('messages.medicine.select_category'),'required']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::select('charge_category_id',$data['chargeCategories'], null, ['class' => 'form-select charge-category','required','id' => 'chargeCategory','placeholder'=>__('messages.pathology_category.select_charge_category'),'required']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
            {{ Form::label('charge_id', __('Charge').':',  ['class' => 'form-label']) }}
            <span class="required"></span>
            {{ Form::select('charge_id',[], null, ['class' => 'form-select charge-code','required','disabled','id' => 'chargeCode','placeholder'=>__('Select Charge'),'required']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            @endif
            {{ Form::text('standard_charge', null, ['class' => 'form-control price-input rd-test-standard-charge', 'id' => 'rdStandardCharge', 'readonly', 'required', 'placeholder' => __('messages.radiology_test.standard_charge')]) }}
        </div>
    </div>
