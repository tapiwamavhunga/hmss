<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::select('category_id', $data['radiologyCategories'], null, ['class' => 'form-select radiology-categories-name', 'required', 'id' => 'editCategoryName', 'placeholder' => 'Select Category', 'required']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
    ...
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            <span class="required"></span>
            {{ Form::select('charge_id', $data['chargeCodes'], null, ['class' => 'form-select charge-code', 'required', 'id' => 'chargeCode', 'placeholder' => __('Select Charge'), 'required']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
            ...
            @endif
            {{ Form::text('standard_charge', null, ['class' => 'form-control price-input rd-test-standard-charge', 'id' => 'editRdTestStandardCharge', 'readonly', 'required', 'placeholder' => __('messages.radiology_test.standard_charge')]) }}
        </div>
    </div>
