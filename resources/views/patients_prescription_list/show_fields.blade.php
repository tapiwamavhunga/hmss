        ...
        <div>
            <div class="card-body  border-top p-9">
                <div class="row mb-7">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-2 d-flex flex-column">
                        {{ Form::label('medical_history', __('messages.new_change.added_at').':', ['class' => 'fw-bold text-muted py-3']) }}
                        <span
                            class="fw-bolder fs-6 text-gray-800">{{ (isset($prescription->medical_history)) ?  \Carbon\Carbon::parse($prescription->medical_history)->translatedFormat('jS M, Y') : __('messages.common.n/a') }}</span>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-2 d-flex flex-column">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-2 d-flex flex-column">
                        ...
                        <p class="m-0"><span
                                    class="badge fs-6 bg-light-{{($prescription->status === 1) ? 'success' : 'danger'}}">{{($prescription->status === 1) ? __('messages.filter.active') : __('messages.filter.deactive')}}</span>
                        </p>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-2 d-flex flex-column">
