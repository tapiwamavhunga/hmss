            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 text-lg-end text-center">
                        <img src="{{ asset('web_front/images/page-banner/about.png') }}" alt="Infy Care" class="img-fluid" loading="lazy" />
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="col-xxl-3 col-lg-4 col-md-6 text-center doctors-block my-lg-1">
                            <div class="px-lg-2 py-3">
                                <a href="{{ route('doctor.details',[$userName,$doctor->id]) }}">
                                    ...
                                    <p class="mb-2">({{ \Illuminate\Support\Str::limit($doctor->user->qualification, 25) }})</p>
