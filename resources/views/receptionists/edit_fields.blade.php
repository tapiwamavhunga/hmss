...
<div class="row">
        ...
        <div class="form-group mb-5">
            ...
            <div class="d-flex align-items-center">
                <div class="form-check me-10">
                    <label class="form-label" for="editMaleReceptionist">{{ __('messages.user.male') }}</label>&nbsp;&nbsp;
                    {{ Form::radio('gender', '0', true, ['class' => 'form-check-input', 'id' => 'editMaleReceptionist']) }}
                </div>
                <div class="form-check me-10">
                    <label class="form-label" for="editFemaleReceptionist">{{ __('messages.user.female') }}</label>&nbsp;
                    {{ Form::radio('gender', '1',false, ['class' => 'form-check-input', 'id' => 'editFemaleReceptionist']) }}
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::text('dob', null, ['id'=>'editReceptionistBirthDate', 'class' => (getLoggedInUser()->theme_mode) ? 'form-control bg-light' : 'form-control bg-white','autocomplete' => 'off', 'placeholder' => __('messages.user.dob')]) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
            {{ Form::label('blood_group',__('messages.user.blood_group').(':'), ['class' => 'form-label']) }}
            {{ Form::select('blood_group', $bloodGroup, null, ['class' => 'form-select form-select-solid', 'id' => 'editReceptionistBloodGroup'
...
<div class="row mt-3">
    ...
    <div class="col-md-6">
        <div class="form-group mb-5">
            ...
            {{ Form::text('address1', isset($receptionist->address->address1) ? $receptionist->address->address1 : null, ['class' => 'form-control', 'placeholder' => __('messages.user.address1')]) }}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group mb-5">
            {{ Form::label('address2',__('messages.user.address2').(':'), ['class' => 'form-label']) }}
            {{ Form::text('address2', isset($receptionist->address->address2) ? $receptionist->address->address2 : null, ['class' => 'form-control', 'placeholder' => __('messages.user.address2')]) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
            {{ Form::label('city',__('messages.user.city').(':'), ['class' => 'form-label']) }}
            {{ Form::text('city', isset($receptionist->address->city) ? $receptionist->address->city : null, ['class' => 'form-control', 'placeholder' => __('messages.user.city')]) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group mb-5">
            {{ Form::label('zip',__('messages.user.zip').(':'), ['class' => 'form-label']) }}
            {{ Form::text('zip', isset($receptionist->address->zip) ? $receptionist->address->zip : null, ['class' => 'form-control', 'maxlength' => '6','minlength' => '6', 'placeholder' => __('messages.user.zip')]) }}
        </div>
    </div>
