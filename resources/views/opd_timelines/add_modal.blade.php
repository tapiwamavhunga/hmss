                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 mb-5">
                        <div class="form-group">
                            ...
                            <span class="required"></span>
                            {{ Form::text('date', null, ['class' => (getLoggedInUser()->thememode ? 'bg-light timelineDate form-control' : 'bg-white timelineDate form-control'),'id' => 'opdTimelineDate','autocomplete' => 'off', 'required',' placeholder' => __('messages.ipd_patient_timeline.date')]) }}
                        </div>
                    </div>
                    <div class="form-group col-md-6 mb-5">
                        <div class="form-group">
