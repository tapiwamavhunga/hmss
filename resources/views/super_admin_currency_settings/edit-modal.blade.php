<div id="edit_admin_currency_modal" class="modal fade" role="dialog" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                {{ Form::hidden('id',null,['id'=>'editAdminCurrencyId']) }}
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('name',__('messages.currency.currency_name'), ['class' => 'form-label']) }}
                        <span class="required"></span>
                        {{ Form::text('currency_name', '', ['id'=>'editAdminCurrencyName','class' => 'form-control','required', 'placeholder' => __('messages.currency.currency_name')]) }}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        <span class="required"></span>
                        {{ Form::text('currency_icon', '', ['id'=>'editAdminCurrencyIcon','class' => 'form-control','required', 'placeholder' => __('messages.currency.currency_icon')]) }}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        <span class="required"></span>
                        {{ Form::text('currency_code', '', ['id'=>'editAdminCurrencyCode','class' => 'form-control','required', 'placeholder' => __('messages.currency.currency_code')]) }}
                    </div>
                </div>
