...
<script id="medicineBillTemplate" type="text/x-jsrender">
    ...
    <td class="table__item-desc">
            ...
            <select class="form-select medicinebillCategories select2Selector medicineBillCategoriesId" required name="category_id[]" data-id="{{:uniqueId}}" id="medicineBillCategoriesId{{:uniqueId}}" >
        ...
        <td class="table__item-desc">
            ...
            <select class="form-select medicinePurchaseId purchaseMedicineId" id='medicine{{:uniqueId}}' required name="medicine[]" data-id="{{:uniqueId}}" >
                <!-- <option value="" disabled selected>Select your option</option> -->
            </select>
        </td>
        <!-- <td>
        ...
        <td>
            <input class="form-control medicineBillExpiryDate bg-white" placeholder="Expiry Date" required name="expiry_date[]"  id="expiry_date{{:uniqueId}}" type="text">
        </td>
        <td>
            <input class="form-control medicineBill-sale-price" value='0.00' name="sale_price[]" required id="medicine_sale_price{{:uniqueId}}" type="text">
        </td>
        <td>
            <div class="input-group">
                <input type="number" class="form-control medicineBill-quantity" value='0' name="quantity[]" required id="quantity{{:uniqueId}}">
            ...
            <input type="number" class="form-control medicineBill-tax" value='0'  name="tax_medicine[]"  id="tax{{:uniqueId}}">
             <span class="input-group-text ms-0" id="amountTypeSymbol">%</span>
                ...
                <td>
            <input type="number" class="form-control medicine-bill-amount" required readonly value='0.00' name="amount[]" id="amount{{:uniqueId}}">
