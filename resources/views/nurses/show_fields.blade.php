<div>
            ...
            <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                <div class="me-7 mb-4">
                    <div class="image image-circle image-small">
                        <img src="{{$nurse->user->image_url}}" alt="image" class="object-fit-cover"/>
                    </div>
                </div>
    ...
    <div class="tab-content" id="myTabContent">
                    ...
                    <div class="card-body p-9">
                        <div class="row">
                            <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                                <label class="pb-2 fs-5 text-gray-600">{{ __('messages.user.first_name')  }}</label>
                                <div class="col-lg-8">
                            ...
                            <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                                ...
                                <div class="col-lg-8">
                                    <span class="fs-5 text-gray-800">{{!empty($nurse->user->phone)?$nurse->user->region_code.$nurse->user->phone:'N/A'}}</span>
                                </div>
                            </div>
                            <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
        ...
        <div class="tab-pane fade" id="apayrolls" role="tabpanel">
            <livewire:nurse-payroll-table nurseId="{{$nurse->id}}" lazy/>
        </div>
    </div>
</div>
