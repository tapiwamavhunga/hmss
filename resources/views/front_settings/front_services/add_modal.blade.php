            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        <span class="required"></span>
                        {{ Form::textarea('short_description', null, ['class' => 'form-control','rows' => 6, 'placeholder' => __('messages.short_description')]) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                                ...
                                <div class="image-picker">
                                    ...
                                    data-bs-original-title="{{ __('messages.icon') }}">
                                            ...
                                            <i class="fa-solid fa-pen" id="profileImageIcon"></i>
                                                {{ Form::file('icon',['id'=>'frontServiceIcon','class' => 'image-upload d-none document-file','accept' => 'image/*']) }}
