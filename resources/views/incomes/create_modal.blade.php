            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        <span class="required"></span>
                        {{ Form::text('name', null, ['class' => 'form-control','required', 'placeholder' => __('messages.incomes.name')]) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                        {{ Form::label('date', __('messages.incomes.date').(':'), ['class' => 'form-label']) }}
                        <span class="required"></span>
                        {{ Form::text('date', null, ['class' => (getLoggedInUser()->thememode ? 'bg-light form-control' : 'bg-white form-control'),'required', 'id' => 'incomeDate', 'autocomplete' => 'off', 'placeholder' => __('messages.incomes.date')]) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        <span class="required"></span>
                        {{ Form::text('amount', null, ['id'=>'incomeAmount','class' => 'form-control price-input', 'autocomplete' => 'off', 'required',  'required', 'placeholder' => __('messages.incomes.amount')]) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                            ...
                            <span class="picker-edit rounded-circle text-gray-500 fs-small"
                                  title="{{ __('messages.incomes.attachment') }}">
                                    ...
                                    <i class="fa-solid fa-pen" id="profileImageIcon"></i>
                                        <input type="file" id="incomeAttachments" name="attachment"
