...
?>
<div class="no-record text-center d-none">{{ __('messages.new_change.no_records_found') }}</div>
...
@role('Admin')
    ...
    {{-- Users --}}
    <li
        class="nav-item  {{ Request::is('users*', 'accountants*', 'lab-technicians*', 'nurses*', 'pharmacists*', 'receptionists*') ? 'active' : '' }}">
    ...
    @module('Appointments', $modules)
        @if (isFeatureAllowToUse('appointments.index', $subscriptionPlanFeaturesId))
    ...
    @if ($billingMGT)
        <li
            class="nav-item  {{ Request::is('accounts*', 'employee-payrolls*', 'invoices*', 'payments*', 'payment-reports*', 'advanced-payments*', 'bills*', 'manual-billing-payments*') ? 'active' : '' }}">
            <a class="nav-link  d-flex align-items-center py-3 " href="{{ $billingMGT }}">
                ...
                <span class="aside-menu-title">{{ __('messages.billings') }}</span>
                ...
                <span class="d-none">{{ __('messages.manual_billing_payments') }}</span>
            </a>
        </li>
    @endif
    ...
    @if ($bedMGT)
        ...
        <li
            ...
            <a class="nav-link  d-flex align-items-center py-3 " href="{{ $bedMGT }}" s>
    ...
    {{-- Blood Bank dropdown --}}
    @if (isFeatureAllowToUse('blood-banks.index', $subscriptionPlanFeaturesId))
        {{-- Blood Bank dropdown --}}
        <?php
    ...
    {{-- Documents Mgt --}}
    @if (isFeatureAllowToUse('documents.index', $subscriptionPlanFeaturesId))
        <?php
    ...
    ?>
    @if ($prescriptionMGT)
        <li class="nav-item {{ Request::is('prescriptions*','prescription-medicine-show*') ? 'active' : '' }}">
    ...
    ?>
    @if ($diagnosisMGT)
        <li class="nav-item {{ Request::is('diagnosis-categories*', 'patient-diagnosis-test*','patient-diagnosis-report*') ? 'active' : '' }}">
    ...
    @if ($ipdOPD)
        <li class="nav-item {{ Request::is('ipds*', 'opds*') ? 'active' : '' }}">
            <a class="nav-link  d-flex align-items-center py-3 " href="{{ $ipdOPD }}"
    ...
    @if (isFeatureAllowToUse('item-categories.index', $subscriptionPlanFeaturesId))
        <?php
    ...
    {{-- Live Consultation --}}
    @if (isFeatureAllowToUse('live.consultation.index', $subscriptionPlanFeaturesId))
        <?php
    ...
    @if ($medicineMgt)
        <li
            class="nav-item {{ Request::is('categories*', 'brands*', 'medicines*', 'medicine-purchase*', 'medicine-bills*', 'used-medicine*', 'medicine-purchase*') ? 'active' : '' }}">
    ...
    @if ($patientCaseMgt)
        <li
            class="nav-item {{ Request::is('patients*', 'patient-cases*', 'case-handlers*', 'patient-admissions*', 'patient-smart-card-templates*', 'generate-patient-smart-cards*') ? 'active' : '' }}">
            <a class="nav-link  d-flex align-items-center py-3 " href="{{ $patientCaseMgt }}">
                ...
                <span class="d-none">{{ __('messages.lunch_break.smart_patient_card_template') }}</span>
                <span class="d-none">{{ __('messages.lunch_break.generate_smart_patient_cards') }}</span>
            </a>
        </li>
    @endif
    ...
    {{-- Pathology --}}
    @if (isFeatureAllowToUse('pathology.category.index', $subscriptionPlanFeaturesId))
        <?php
        $pathologyMgt = getMenuLinks(\App\Models\User::MAIN_PATHOLOGY);
        ?>
        @if ($pathologyMgt)
            <li
                class="nav-item {{ Request::is('pathology-categories*', 'pathology-tests*', 'pathology-units*', 'pathology-parameters*') ? 'active' : '' }}">
                <a class="nav-link  d-flex align-items-center py-3 " href="{{ $pathologyMgt }}">
                    ...
                    <span class="d-none">{{ __('messages.new_change.pathology_unit') }}</span>
                    <span class="d-none">{{ __('messages.new_change.pathology_parameter') }}</span>
    ...
    @if (isFeatureAllowToUse('birth-reports.index', $subscriptionPlanFeaturesId))
        <?php
    ...
    {{-- Radiology --}}
    @if (isFeatureAllowToUse('radiology.category.index', $subscriptionPlanFeaturesId))
        <?php
    ...
    {{-- sms/mail --}}
    @if (isFeatureAllowToUse('sms.index', $subscriptionPlanFeaturesId))
        <?php
        ...
        @if ($smsMailMgt)
            <li class="nav-item {{ Request::is('sms*', 'mail*') ? 'active' : '' }}">
                <a class="nav-link  d-flex align-items-center py-3 " href="{{ $smsMailMgt }}"
                    title="{{ __('messages.sms.sms_mail') }}">
                    <span class="aside-menu-icon pe-3">
                        <i class="fas fa-bell"></i>
                    </span>
                    <span class="aside-menu-title">{{ __('messages.sms.sms_mail') }}</span>
    ...
    {{-- Settings --}}
    <li
        class="nav-item  {{ Request::is('currency-settings*', 'settings*', 'hospital-schedules', 'payment-gateway*', 'custom-fields*') ? 'active' : '' }}">
    ...
    <li class="nav-item  {{ Request::is('my-transactions*') ? 'active' : '' }}">
        <a class="nav-link  d-flex align-items-center py-3 "
            href="{{ route('subscriptions.plans.transactions.index') }}">
            <span class="aside-menu-icon pe-3">
                <i class="fas fa-money-bill-wave"></i>
            </span>
            <span class="aside-menu-title">{{ __('messages.subscription_plans.transactions') }}</span>
        </a>
    </li>


    {{-- Vaccination --}}
    @if (isFeatureAllowToUse('vaccinated-patients.index', $subscriptionPlanFeaturesId))
        <?php
...
@if (Auth::user()->email_verified_at != null)
    @role('Doctor')
        ...
        @if ($bedDoctorMGT)
            {{-- Bed Management --}}
            <li class="nav-item {{ Request::is('bed-assigns*','patient-cases*', 'bed-status') ? 'active' : '' }}">
        ...
        @module('Doctors', $modules)
            <li class="nav-item {{ Request::is('employee/doctor*', 'doctors*', 'holidays*', 'breaks*') ? 'active' : '' }}">
                <a class="nav-link  d-flex align-items-center py-3 " href="{{ route('doctor') }}">
                    <span class="aside-menu-icon pe-3"><i class="fa fa-user-md"></i></span>
                    <span class="aside-menu-title">{{ __('messages.doctors') }}</span>
                    <span class="d-none">{{ __('messages.schedules') }}</span>
                    <span class="d-none">{{ __('messages.holiday.doctor_holiday') }}</span>
        ...
        @if ($diagnosisDoctorMGT)
            <li class="nav-item {{ Request::is('patient-diagnosis-report*','diagnosis-categories*', 'patient-diagnosis-test*') ? 'active' : '' }}">
        ...
        @module('Notice Boards', $modules)
            ...
            @if (isFeatureAllowToUse('live.consultation.index', $subscriptionPlanFeaturesId))
                ...
                ?>
                @if ($liveConsultation)
                    <li class="nav-item {{ Request::is('live-consultation*', 'live-meeting*','connect-google-calendar') ? 'active' : '' }}">
                        <a class="nav-link  d-flex align-items-center py-3 " href="{{ $liveConsultation }}">
                            <span class="aside-menu-icon pe-3"><i class="fa fa-video"></i></span>
                            <span class="aside-menu-title">{{ __('messages.live_consultations') }}</span>
                            <span class="d-none">{{ __('messages.live_meetings') }}</span>
            ...
            @if ($patientDoctorCaseMgt)
                <li class="nav-item  {{ Request::is('patient-admissions*', 'patients*') ? 'active' : '' }}">
    ...
    @role('Case Manager')
        ...
        @module('Notice Boards', $modules)
            ...
            @module('Live Meetings', $modules)
                @if (isFeatureAllowToUse('live.meeting.index', $subscriptionPlanFeaturesId))
                ...
                @if ($smsMailCaseManagerMgt)
                    <li class="nav-item  {{ Request::is('sms*', 'mail*') ? 'active' : '' }}">
                        <a class="nav-link  d-flex align-items-center py-3 " href="{{ route('sms.index') }}"
                            ...
                            <span class="aside-menu-title">{{ __('SMS/Mail') }}</span>
                        </a>
                    </li>
                @endif
            @endif
    ...
    @role('Receptionist')
        ...
        @if ($billingMGT)
            <li
                class="nav-item  {{ Request::is('accounts*', 'employee-payrolls*', 'invoices*', 'payments*', 'payment-reports*', 'advanced-payments*', 'bills*', 'manual-billing-payments*') ? 'active' : '' }}">
                <a class="nav-link  d-flex align-items-center py-3 " href="{{ route('bills.index') }}">
                    <span class="aside-menu-icon pe-3"><i class="fas fa-file-invoice-dollar"></i></span>
                    <span class="aside-menu-title">{{ __('messages.billings') }}</span>
                    <span class="d-none">{{ __('messages.employee_payrolls') }}</span>
                    <span class="d-none">{{ __('messages.invoices') }}</span>
        ...
        @if ($frontReceptionistOfficeMGT)
            <li class="nav-item {{ Request::is('call-logs*', 'visitor*', 'receives*', 'dispatches*') ? 'active' : '' }}">
                <a class="nav-link  d-flex align-items-center py-3 " href="{{ $frontReceptionistOfficeMGT }}">
                    <span class="aside-menu-icon pe-3"><i class="fa fa-dungeon"></i></span>
                    <span class="aside-menu-title">{{ __('messages.front_office') }}</span>
                    <span class="d-none">{{ __('messages.call_logs') }}</span>
                    <span class="d-none">{{ __('messages.visitors') }}</span>
        ...
        @module('Notice Boards', $modules)
            <li class="nav-item {{ Request::is('notice-board*', 'testimonials*') ? 'active' : '' }}">
                <a class="nav-link  d-flex align-items-center py-3 " href="{{ route('noticeboard') }}">
                    <span class="aside-menu-icon pe-3"><i class="fas fa fa-cog"></i></span>
        ...
        @if ($receptionistIpdOPD)
            <li class="nav-item {{ Request::is('ipds*', 'opds*') ? 'active' : '' }}">
                <a class="nav-link  d-flex align-items-center py-3 " href="{{ $receptionistIpdOPD }}"
                    title="{{ __('messages.ipd_opd') }}">
                    <span class="aside-menu-icon pe-3">
                        <i class="fas fa-notes-medical"></i>
                    </span>
        ...
        @if (isFeatureAllowToUse('pathology.category.index', $subscriptionPlanFeaturesId))
            ...
            @if ($receptionistPathologyMgt)
                <li class="nav-item {{ Request::is('pathology-categories*', 'pathology-tests*','pathology-units*','pathology-parameters*') ? 'active' : '' }}">
        ...
        {{-- <li class="nav-item"> --}}
        {{--    <a class="nav-link  d-flex align-items-center py-3  {{ Request::is('testimonials*') ? 'active' : '' }}" --}}
    ...
    @role('Pharmacist')
        ...
        @if ($medicinePharmacistMgt)
            <li
                class="nav-item {{ Request::is('categories*', 'brands*', 'medicines*', 'medicine-bills*', 'used-medicine*', 'medicine-purchase*') ? 'active' : '' }}">
        ...
        @module('Pathology Tests', $modules)
            @if (isFeatureAllowToUse('pathology.test.index', $subscriptionPlanFeaturesId))
        ...
        @module('Radiology Tests', $modules)
            @if (isFeatureAllowToUse('radiology.test.index', $subscriptionPlanFeaturesId))
    ...
    @role('Lab Technician')
        ...
        @if ($diagnosiLabMGT)
            <li
                class="nav-item  {{ Request::is('diagnosis-categories*', 'patient-diagnosis-test*', 'patient-diagnosis-report*') ? 'active' : '' }}">
    ...
    @role('Patient')
        ...
        <li class="nav-item  {{ Request::is('patient/dashboard*') ? 'active' : '' }}">
            <a class="nav-link  d-flex align-items-center py-3 " href="{{ route('patient.dashboard') }}">
        ...
        {{-- Patient Smart Card --}}
        {{-- <li class="nav-item  {{ Request::is('patient-smart-cards*') ? 'active' : '' }}">
            <a class="nav-link  d-flex align-items-center py-3 " href="{{ route('patient-smart-cards.index') }}">
                <span class="aside-menu-icon pe-3"><i class="fa fa-id-card" aria-hidden="true"></i></span>
                <span class="aside-menu-title">{{ __('messages.lunch_break.patient_smart_cards') }}</span>
                <span class="d-none">{{ __('messages.lunch_break.generate_smart_patient_cards') }}</span>
            </a>
        </li> --}}
        ...
        @module('Diagnosis Tests', $modules)
            <li class="nav-item  {{ Request::is('employee/patient-diagnosis-test*') ? 'active' : '' }}">
                <a class="nav-link  d-flex align-items-center py-3 " href="{{ route('patient-diagnosis-test') }}">
                    <span class="aside-menu-icon pe-3"><i class="fas fa-file-medical"></i></span>
        ...
        @module('Invoices', $modules)
            <li class="nav-item {{ Request::is('employee/invoices*') ? 'active' : '' }}">
                <a class="nav-link  d-flex align-items-center py-3 " href="{{ route('invoices') }}">
        ...
        @module('Patient Cases', $modules)
            <li class="nav-item  {{ Request::is('patient/my-cases*') ? 'active' : '' }}">
                <a class="nav-link  d-flex align-items-center py-3 " href="{{ route('patients.cases') }}">
        ...
        @module('Patient Admissions', $modules)
            <li class="nav-item {{ Request::is('employee/patient-admissions*') ? 'active' : '' }}">
                <a class="nav-link  d-flex align-items-center py-3 " href="{{ route('patient-admissions') }}">
...
@role('Super Admin')
    ...
    <li class="nav-item {{ Request::is('super-admin/dashboard*') ? 'active' : '' }}" data-turbo="false">
    ...
    {{-- Super Admin Users --}}
    <li class="nav-item {{ Request::is('super-admin/admins*') ? 'active' : '' }}">
    ...
    {{-- Super Admin Users --}}
    {{-- <li class="nav-item {{ Request::is('super-admin/hospital-type*') ? 'active' : '' }}"> --}}
    {{--    <a class="nav-link d-flex align-items-center py-3 " aria-current="page" --}}
    {{--       href="{{ url('super-admin/hospital-type') }}"> --}}
    {{--        <span class="aside-menu-icon pe-3"><i class="fas fa-user-friends"></i></span> --}}
    {{--        <span class="aside-menu-title">{{ __('messages.hospitals_type') }}</span> --}}
    {{--    </a> --}}
    {{-- </li> --}}
    ...
    <li class="nav-item {{ Request::is('super-admin/hospital-type*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 " aria-current="page"
            href="{{ route('super.admin.hospitals.type.index') }}">
    ...
    {{-- Super Admin Users --}}
    <li
        class="nav-item {{ Route::is('super.admin.hospitals.index', 'hospital.create', 'hospital.edit') || Request::is('super-admin/hospitals*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 " aria-current="page"
            href="{{ route('super.admin.hospitals.index') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa-user-friends"></i></span>
            <span class="aside-menu-title">{{ __('messages.hospitals') }}</span>
        </a>
    </li>

    {{-- Super Admin Subscription Plan --}}
    <li
        class="nav-item {{ Request::is('super-admin/subscription-plans*', 'super-admin/transactions*', 'super-admin/subscriptions-hospitals*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 " aria-current="page"
    ...
    <li class="nav-item  {{ Request::is('super-admin/subscribers*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 " href="{{ route('super.admin.subscribe.index') }}">
            <span class="aside-menu-icon pe-3">
    ...
    <li class="nav-item  {{ Request::is('super-admin/enquiries*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 " href="{{ route('super.admin.enquiry.index') }}">
            <span class="aside-menu-icon pe-3">
    ...
    <li
        class="nav-item {{ Request::is('super-admin/section-one*', 'super-admin/section-two*', 'super-admin/section-three*', 'super-admin/section-four*', 'super-admin/service-slider*', 'super-admin/admin-testimonial*', 'super-admin/faqs*', 'super-admin/section-five*', 'super-admin/about-us*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 " href="{{ route('super.admin.section.one') }}">
            <span class="aside-menu-icon pe-3">
    ...
    {{-- Settings --}}
    <li
        class="nav-item  {{ Request::is('super-admin/general-settings*', 'super-admin/footer-settings*', 'super-admin/super-admin-currency-settings*', 'super-admin/payment-gateway*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3 " href="{{ route('super.admin.settings.edit') }}">
            <span class="aside-menu-icon pe-3"><i class="fa fa-cogs"></i></span>
            <span class="aside-menu-title">{{ __('messages.settings') }}</span>
            <span class="d-none">{{ __('messages.general') }}</span>
            <span class="d-none">{{ __('messages.sidebar_setting') }}</span>
