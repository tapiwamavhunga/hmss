            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('zoom_api_key', '', ['class' => 'form-control','required', 'id' => 'zoomApiKey', 'autocomplete' => 'off', 'placeholder' => __('messages.live_consultation.zoom_api_key')]) }}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        <span class="required"></span>
                        {{ Form::text('zoom_api_secret', '', ['class' => 'form-control','required', 'id' => 'zoomApiSecret', 'autocomplete' => 'off', 'placeholder' => __('messages.live_consultation.zoom_api_secret')]) }}
                    </div>
                </div>
                <div class="row">
