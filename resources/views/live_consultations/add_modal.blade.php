            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4 mb-5">
                        ...
                        <span class="required"></span>
                        {{ Form::text('consultation_date', '', ['class' => getLoggedInUser()->thememode ? 'bg-light consultation-date form-control' : 'bg-white consultation-date form-control', 'required', 'id' => 'liveConsultationDate', 'autocomplete' => 'off', 'placeholder' => __('messages.live_consultation.consultation_date')]) }}
                    </div>
                    <div class="form-group col-sm-4 mb-5">
                        {{ Form::label('platform_type', __('messages.google_meet.platform_type') . ':', ['class' => 'form-label']) }}
                        <span class="required"></span>
                        @if (getLoggedinDoctor())
                            {{ Form::select('platform_type', \App\Models\LiveConsultation::PLATFORM_TYPE, [], ['class' => 'form-select platform-type', 'placeholder' => __('Select Platform'), 'id' => 'platFormType', 'required', 'data-control' => 'select2']) }}
                        @else
                            {{ Form::select('platform_type', \App\Models\LiveConsultation::PLATFORM_TYPE_ZOOM, [], ['class' => 'form-select platform-type', 'placeholder' => __('Select Platform'), 'id' => 'platFormType', 'required', 'data-control' => 'select2']) }}
                        @endif
                    </div>
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        <span class="required"></span>
                        {{ Form::select('patient_id', $patients, null, ['class' => 'form-select patient-name', 'placeholder' => __('messages.user.select_patient_name'), 'id' => 'consultationPatientName', 'required', 'data-control' => 'select2']) }}
                    </div>
                    ...
                    <div class="form-group col-sm-4 mb-5">
                        ...
                        <span class="required"></span>
                        {{ Form::select('type', $type, null, ['class' => 'form-select select2Selector consultation-type', 'placeholder' => __('messages.common.select_type'), 'disabled', 'required', 'data-control' => 'select2']) }}
                    </div>
                    <div class="form-group col-sm-4 mb-5">
                        {{ Form::label('type_number', __('messages.live_consultation.type_number') . ':', ['class' => 'form-label']) }}
                        <span class="required"></span>
                        {{ Form::select('type_number', [null], null, ['class' => 'form-select select2Selector consultation-type-number', 'id' => 'consultationTypeNumber', 'placeholder' => __('messages.common.select_type_number'), 'disabled', 'required', 'data-control' => 'select2']) }}
                    </div>
